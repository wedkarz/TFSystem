...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      '../target/web/public/main/lib/ng-table/ng-table.js',
      '../target/web/public/main/lib/angular-ui/angular-ui.js',
      '../target/web/public/main/lib/jquery/jquery.js',
      '../target/web/public/main/lib/underscorejs/underscore.js',
      '../public/javascripts/lib/angular-toastr.js',
      '*.js',
