...
class PresentationManagerTest {
  ...
  val presentationOne = Presentation(Some(1L), Some("bbb"), Some("15-16"), Some("Presenter 1, Presenter 2"), Some("desc1"), Some(2L))
  val presentationTwo = Presentation(Some(2L), Some("ccc"), Some("15-16"), Some("Presenter 1, Presenter 3"), Some("desc2"), Some(2L))
  val presentationThree = Presentation(Some(3L), Some("ddd"), Some("16-17"), Some("Presenter 1, Presenter 2"), Some("desc3"), Some(2L))
  val presentationOneUpdated = Presentation(Some(1L), Some("aaa"), Some("15-16.30"), Some("Presenter 1"), Some("desc4"), Some(2L))
